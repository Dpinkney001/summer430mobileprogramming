package com.example.inclassimplicitintents;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void setOnClickListenersForButtons(){
        ...
        Log.d(TAG, "end of setOnClickListenersForButtons method");
    }
    ...
    private void openWebPage(){
        ...
        if(intent.resolveActivity(getPackageManager())   !=  null  ){
            ...
            Log.d(TAG, "Cannot handle opeing webpage "+url);
            Toast.makeText(this, "Cannot handle opeing webpage "+url, Toast.LENGTH_LONG).show();
        }
...
//        startActivity(intent);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(resultCode== RESULT_OK && requestCode==REQUEST_IMAGE_CAPTURE) {
            Intent intentShowImage = new Intent(this, ShowImageActivity.class);//explicit intent to trigger the second activity in this application
            intentShowImage.putExtras(data); //pass the data received (image captured) along to the second activity in this application
